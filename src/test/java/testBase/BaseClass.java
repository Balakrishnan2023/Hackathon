...
public class BaseClass {
	...
	public void setup(@Optional("Windows") String os, @Optional("chrome") String browser) throws IOException {
		...
		FileReader file = new FileReader(
				"C:\\Hackathon\\2361584_BalaKrishnan\\identifying_courses\\src\\test\\resources\\config.properties");
	...
	public void takeScreenshot(String name) throws IOException {
		...
		File target = new File("C:\\Hackathon\\2361584_BalaKrishnan\\identifying_courses\\screenshots" + name + ".png");
